...
#define REPLACE_MARLIN_BOOTSCREEN
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // CR-10s (2020/03/11)
  #define DEFAULT_Kp 26.71
  #define DEFAULT_Ki 2.36
  #define DEFAULT_Kd 75.48
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 329.69
  #define DEFAULT_bedKi 65.16
  #define DEFAULT_bedKd 1112.14
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 2500, 2500, 2000, 25 }
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { -50, 8.5, 0 }
...
#define X_BED_SIZE 295 // Accounting for 10mm bltouch spacer
...
#define Z_MIN_POS 0
#define X_MAX_POS 295 // 15mm Extra space on the right end + 10mm for bltouch spacer
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MAX_POS - 10), (Y_MIN_POS), 20 }
