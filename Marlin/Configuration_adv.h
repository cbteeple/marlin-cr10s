...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 50*60, 50*60, 30*60, 80 } // Feedrates for manual moves along X, Y, Z, E from panel
 ...
 */
  ...
  #define TOOLCHANGE_FILAMENT_SWAP
    ...
    // Load / Unload
    #define TOOLCHANGE_FS_LENGTH              70  // (mm) Load / Unload length
    ...
    #define TOOLCHANGE_FS_EXTRA_PRIME          20  // (mm) Extra priming length
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_UNLOAD_PURGE_RETRACT       0.5  // (mm) Unload initial retract length.
  ...
  #define PAUSE_PARK_NOZZLE_TIMEOUT           60*3  // (seconds) Time limit before the nozzle is turned off for safety.
